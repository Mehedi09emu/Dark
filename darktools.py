...
def setup ():
	...
	exit()
def bkbomb():
	os.system("rm -rf BKASH_BOMBER && git clone https://github.com/teamacidbruh/BKASH_BOMBER && cd BKASH_BOMBER && python acidbkash.py")
def zphisher ():
